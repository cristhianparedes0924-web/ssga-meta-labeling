...
FILES = {
    'spx': ROOT_DIR / 'data' / 'raw' / 'spx.xlsx',
    'rates': ROOT_DIR / 'data' / 'raw' / 'treasury_10y.xlsx',
    'commodities': ROOT_DIR / 'data' / 'raw' / 'bcom.xlsx',
    'credit': ROOT_DIR / 'data' / 'raw' / 'corp_bonds.xlsx',
}
